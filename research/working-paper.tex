...
\end{tabular}
\end{center}
\textbf{This is a substantive finding, not a cosmetic one.} Note: $1\times$ is a \textbf{descriptive calibration point, not a normative target} --- the paper measures whether fees cover modeled storage cost; it does not claim $1\times$ is the ``right'' level of coverage. The defensible claim: $\sim$22--29\% average coverage, $\sim$99--100\% of sampled blocks below $1\times$, at the real observed node count ($\geq$32K).
